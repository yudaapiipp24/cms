      ...
      <div class="authentication-inner"> <!-- Inner container untuk otentikasi -->
        ...
        <div class="card"> <!-- Kartu untuk tampilan login -->
          <div class="card-body"> <!-- Badan kartu -->
            <h4 class="mb-2">Buat Akun Dulu!</h4> <!-- Judul selamat datang -->
            <form action="<?= base_url('auth/simpan_user') ?>" method="post"> <!-- Form untuk mengirim data user -->
                            ...
                            <div class="row" hidden> <!-- Baris untuk layout form -->
                                <div class="col mb-3"> <!-- Kolom untuk input -->
                ...
                <button class="btn btn-primary d-grid w-100" type="submit">Register</button> <!-- Tombol untuk mengirim form login -->
              </div>
                </form>
          </div>
        </div>
