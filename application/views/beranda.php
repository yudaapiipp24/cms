...
<body>
    ...
    <section class="hero section dark-background">
        <div class="container-fluid"> <!-- Container untuk header dengan background primer -->
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px"> <!-- Mengatur posisi dan ukuran header -->
                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel"> <!-- Carousel untuk menampilkan gambar -->
                    <div class="carousel-inner"> <!-- Kontainer untuk item carousel -->
                        <?php $no = 1; foreach ($caraousel as $cara) { ?> <!-- Loop untuk menampilkan gambar caraousel -->
                            <div class="carousel-item <?php if ($no == 1) { echo 'active'; } ?>"> <!-- Menentukan item aktif -->
                                <img class="d-block w-100" style="max-width: 100%;" src="<?= base_url('assets/upload/caraousel/' . $cara['foto']) ?>" alt=""> <!-- Gambar caraousel -->
                            </div>
                        <?php $no++; } ?>
                    </div>
                    <a class="carousel-control-prev" href="#carouselExampleControls" role="button" data-slide="prev"> <!-- Kontrol sebelumnya -->
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span> <!-- Ikon kontrol sebelumnya -->
                        <span class="sr-only">Previous</span> <!-- Teks alternatif untuk aksesibilitas -->
                    </a>
                    <a class="carousel-control-next" href="#carouselExampleControls" role="button" data-slide="next"> <!-- Kontrol berikutnya -->
                        <span class="carousel-control-next-icon" aria-hidden="true"></span> <!-- Ikon kontrol berikutnya -->
                        <span class="sr-only">Next</span> <!-- Teks alternatif untuk aksesibilitas -->
                    </a>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        ...
                        <p><?= $konfig->profil_website; ?></p>
                            <a href="<?= $konfig->facebook; ?>"><i class="fa fa-facebook" style="width: 38px; height: 38px"></i></a>
                            <a href="<?= $konfig->instagram; ?>"><i class="fa fa-instagram" style="width: 38px; height: 38px"></i></a>
                    </div>
                </div>
