...
<body>
    ...
    <!-- Detail Start -->
    <div class="container py-5"> <!-- Container untuk halaman detail dengan padding -->
        <div class="row pt-5"> <!-- Baris untuk konten detail -->
            <div class="col-lg-12"> <!-- Kolom untuk konten detail -->
                <div class="d-flex flex-column text-left mb-3"> <!-- Mengatur posisi teks -->
                    <h1 class="mb-3" style="font-size: 50px;"><?= $konten->judul; ?></h1> <!-- Menampilkan judul artikel -->
                    <div class="d-flex"> <!-- Baris untuk informasi tambahan -->
                        <p class="mr-3"><i class="fa fa-user text-primary"></i> <?= $konten->nama; ?></p> <!-- Penulis artikel -->
                        <p class="mr-3"><i class="fa fa-folder text-primary"></i> <?= $konten->nama_kategori; ?></p> <!-- Kategori artikel -->
                    </div>
                </div>
                <div class="mb-5"> <!-- Kontainer untuk gambar dan keterangan -->
                    <img class="img-fluid rounded w-100 mb-4" src="<?= base_url('assets/upload/konten/' . $konten->foto) ?>" /> <!-- Gambar artikel -->
                    <?= $konten->keterangan; ?> <!-- Menampilkan keterangan artikel -->
                </div>
            </div>
        </div>
    </div>
